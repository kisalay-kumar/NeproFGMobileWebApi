        ...
        public ReceivingResponse Receiving(ConfirmMovingReq CMR)
        {
            ...
            try
            {
                ...
                if (dsGetData.Tables[0].Rows[0].ToString() != "2")
                {
                    ...
                    obj.InsertHistoryDetailData(Cct, CMR.StickerNo, "", Convert.ToString(dsGetData.Tables[1].Rows[0]["ActivityName"]), Convert.ToString(dsGetData.Tables[1].Rows[0]["ActivityDesc"]), StillageLocation, Convert.ToString(dsGetData.Tables[1].Rows[0]["UserName"]), "", StillageLocation, "", "", "", "No", 0, "", 0, 0, Convert.ToDecimal(dsGetData.Tables[1].Rows[0]["StillageQty"]), Convert.ToString(dsGetData.Tables[1].Rows[0]["UserName"]), Hold, 0, "", "", "", Convert.ToString(dsGetData.Tables[1].Rows[0]["WareHouseID"]));
                ...
                else
                {
                    ...
                    if (dsGetData.Tables[0].Rows[0]["value"].ToString() != "2")
                    {
                       ...
                       //New//
                        ...
                        obj.InsertHistoryDetailData(Cct, AR.StickerNo, "", Convert.ToString(dsGetData.Tables[1].Rows[0]["ActivityName"]), Convert.ToString(dsGetData.Tables[1].Rows[0]["ActivityDesc"]), Convert.ToString(dsGetData.Tables[1].Rows[0]["StillageLocation"]), "", Convert.ToString(dsGetData.Tables[1].Rows[0]["AssignedFLT"]), "", Convert.ToString(dsGetData.Tables[2].Rows[0]["ZONEID"]), "", "", "No", 0, "", 0, 0, Convert.ToDecimal(dsGetData.Tables[1].Rows[0]["StillageQty"]), Convert.ToString(dsGetData.Tables[1].Rows[0]["UserName"]), Hold, 0, "","","", Convert.ToString(dsGetData.Tables[1].Rows[0]["WareHouseID"]));
                    }
                    else
                    {
                        res.Status = "Failure";
